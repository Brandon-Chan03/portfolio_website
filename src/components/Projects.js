...
import adminDashboard from 'src/assets/img/dashboard1.png'
          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>List of my personal projects. NOTE: Not all my projects are here due to file corruption.</p>
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    ...
                    <Tab.Pane eventKey="second">
                      <p>Sadly this section is empty :(</p>
                    </Tab.Pane>
